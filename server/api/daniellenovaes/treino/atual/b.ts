export default defineEventHandler((event) => {
  ...
  return  [
    ...
    { num: 'Exercício 2', nome: 'Remada na polia baixa', sets: 3, reps: '15', rest: '50"', grupo: '', obs: 'Fazer com a pegada neutra; falhando.', img: 'https://m.leandrocesar.com/img/preImagem.png'},
    ...
    { num: 'Exercício 4', nome: 'Supino inclinado', sets: 3, reps: '15', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/img/preImagem.png'},
    ...
    { num: 'Exercício 7', nome: 'Remada alta na polia baixa', sets: 3, reps: '10 + 10"', rest: '40"', grupo: '', obs: 'Fazer 10 repetições + 10 segundos de isometria em cima no final.', img: 'https://m.leandrocesar.com/img/preImagem.png'},
