export default defineEventHandler((event) => {
  return [
    ...
    { id: 1, num: 'Exercício 1', nome: 'Supino 45º (HBC)', sets: 3, reps: '10', rest: '50"', grupo: '', obs: 'Fazer com halteres; pegada neutra.', img: 'https://deepacupuntura.com/exe/supinoInclinado.gif' },
    { id: 2, num: 'Exercício 2', nome: 'Supino 45º (HBL)', sets: 3, reps: '12', rest: '50"', grupo: '', obs: 'Fazer com a barra longa.', img: 'https://deepacupuntura.com/exe/supino45HBL.gif' },
    { id: 3, num: 'Exercício 3', nome: 'Supino reto hammer', sets: 3, reps: '8 c/2"', rest: '50"', grupo: '', obs: 'Segurar 2 segundos embaixo a cada repetição.', img: 'https://deepacupuntura.com/exe/supinoHammer.gif' },
    ...
    { id: 6, num: 'Exercício 6', nome: 'Desenvolvimento (HBM)', sets: 3, reps: '15', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/desenvolvimentoHBM.gif' },
    { id: 7, num: 'Exercício 7', nome: 'Tríceps Testa barra W', sets: 3, reps: '10', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/tricepsTesta.gif' },
    ...
    { id: 9, num: 'Exercício 9', nome: 'Puxada pronada aberta', sets: 3, reps: '15', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/puxadaFrente.gif' },
    ...
    { id: 11, num: 'Exercício 11', nome: 'Abdominal infra no solo', sets: 3, reps: '', rest: '50"', grupo: '', obs: 'Segurar a mão no espaldar e descer primeiro o quadril, depois a perna.', img: 'https://deepacupuntura.com/exe/abdominalInfra.gif' },
    [
      {
        "exercise": "extensroa",
        "sets": "3",
