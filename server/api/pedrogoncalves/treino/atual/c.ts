export default defineEventHandler((event) => {
  return [
    ...
    },
    {
      "id": 5,
      "num": "Exercício 5",
      "nome": "Puxada no cross (polia alta)",
      "sets": 3,
      "reps": "15",
      "rest": "50\"",
      "grupo": "",
