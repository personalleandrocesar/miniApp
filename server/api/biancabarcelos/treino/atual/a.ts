export default defineEventHandler((event) => {
  return [
    ...
    { id: 2, num: 'Exercício 2', nome: 'Extensora', sets: 4, reps: '15', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/extensora.gif'},
    ...
    { id: 4, num: 'Exercício 4', nome: 'Agachamento Sumô', sets: 3, reps: '20', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/sumo.gif'},
