export default defineEventHandler((event) => {
  return [
    ...
    { num: 'Exercício 7', nome: 'Abdutora', sets: 3, reps: '12/10/8', rest: '40"', grupo: '', obs: 'Fazer pirâmide crescente (aumenta o peso, diminui as repetições).', img: 'https://m.leandrocesar.com/exe/abdutora.gif' },
    { num: 'Exercício 8', nome: 'Agachamento no smith', sets: 3, reps: '10', rest: '40"', grupo: '', obs: '', img: 'https://m.leandrocesar.com/exe/squatSmith.gif' },
