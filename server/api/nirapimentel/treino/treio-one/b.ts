export default defineEventHandler((event) => {
  return [
    // Série Atual
    { id: 1, num: 'Exercício 1', nome: 'Puxada aberta pronada', sets: 3, reps: '15', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/puxadaFrente.gif' },
    ...
    { id: 4, num: 'Exercício 4', nome: 'Remada alta na polia baixa', sets: 3, reps: '12', rest: '50"', grupo: '', obs: 'Pegada fechada.', img: 'https://deepacupuntura.com/exe/remadaAlta.gif' },
    { id: 5, num: 'Exercício 5', nome: 'Bíceps em pé na polia baixa', sets: 3, reps: '10', rest: '50"', grupo: '', obs: 'Pegada supinada.', img: 'https://deepacupuntura.com/exe/bicepsPolia.gif' },
    { id: 6, num: 'Exercício 6', nome: 'Supino inclinado com halteres', sets: 3, reps: '12', rest: '50"', grupo: '', obs: 'Pegada pronada.', img: 'https://deepacupuntura.com/exe/supinoInclinado.gif' },
    { id: 7, num: 'Exercício 7', nome: 'Desenvolvimento de ombros (HBC)', sets: 3, reps: '12', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/desenvolvimentoHalteres.gif' },
    { id: 8, num: 'Exercício 8', nome: 'Tríceps corda na polia alta', sets: 3, reps: '12 +10" +6', rest: '50"', grupo: '', obs: 'Fazer 12 repetições, segurar 10 segundos embaixo e fazer + 6 repetiçẽos.', img: 'https://deepacupuntura.com/exe/tricepsCorda.gif' },
    { id: 9, num: 'Exercício 9', nome: 'Tríceps máquina', sets: 3, reps: '20', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/tricepsMaquina.gif' },
    { id: 10, num: 'Exercício 10', nome: 'Pull-Down', sets: 3, reps: '15', rest: '50"', grupo: '', obs: 'Fazer na polia alta com a ', img: 'https://deepacupuntura.com/exe/pullDown.gif' },
