export default defineEventHandler((event) => {
  return [
    // Série Atual
    { num: 'Exercício 1', nome: 'Mesa flexora', sets: 3, reps: '12 +10"', rest: '50"', grupo: '', obs: 'Fazer 12 repetições e segurar 10" em cima!', img: 'https://deepacupuntura.com/exe/mesaFlexora.gif' },
    { num: 'Exercício 2', nome: 'Leg press 45º', sets: 3, reps: '12', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/leg45.gif' },
    { num: 'Exercício 3', nome: 'Elevação Pélvica', sets: 3, reps: '15', rest: '50"', grupo: '', obs: 'Fazer no aparelho', img: 'https://deepacupuntura.com/exe/elevacaoPelvicaHBM.gif' },
    { num: 'Exercício 4', nome: 'Stiff', sets: 3, reps: '12', rest: '50"', grupo: '', obs: 'Falhando.', img: 'https://deepacupuntura.com/exe/stiffHBL.gif' },
    { num: 'Exercício 5', nome: 'Abdução de quadril na polia baixa', sets: 3, reps: '12', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/abducaoPolia.gif' },
    { num: 'Exercício 6', nome: 'Panturrilha aparelho em pé', sets: 2, reps: '20 c/ 1"', rest: '50"', grupo: '', obs: 'Segurar 1" em cima à cada repetição.', img: 'https://deepacupuntura.com/exe/panturrilhaAparelho.gif' },
    { num: 'Exercício 7', nome: 'Puxada Supinada + pronada', sets: 3, reps: '8 + 8', rest: '50"', grupo: '', obs: 'Fazer 8 pergada supinada + 10 pegada pronada', img: 'https://deepacupuntura.com/exe/puxadaFechadaPronada.gif' },
    { num: 'Exercício 8', nome: 'Remada máquina (peg. pronada)', sets: 3, reps: '20', rest: '50"', grupo: 'Fazer com 2 tempos.', obs: '', img: 'https://deepacupuntura.com/exe/remadaMaquina.png' },
    ...
    { num: 'Exercício 11', nome: 'Bíceps em pé na polia baixa', sets: 3, reps: '10', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/bicepsPolia.gif' },
