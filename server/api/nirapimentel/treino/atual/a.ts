export default defineEventHandler((event) => {
  return [
    ...
    { num: 'Exercício 4', nome: 'Leg press (pés paralelos)', sets: 3, reps: '12', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/legpress.gif' },
    { num: 'Exercício 5', nome: 'Adutora', sets: 4, reps: '20 c/ 2t', rest: '50"', grupo: '', obs: 'fazer 2 tempos de contração a cada repetição.', img: 'https://deepacupuntura.com/exe/adutora.gif' },
    ...
    { num: 'Exercício 10', nome: 'Tríceps corda na polia alta', sets: 3, reps: '20 c/ 2t', rest: '50"', grupo: '', obs: 'Fazer com 2 tempos embaixo a cada repetição.', img: 'https://deepacupuntura.com/exe/tricepsCorda.gif' },
