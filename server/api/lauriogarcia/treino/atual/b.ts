export default defineEventHandler((event) => {
  return [
    // Série Atual
    { id: 1, num: 'Exercício 1', nome: 'Remada hammer', sets: 3, reps: '8 +8" +8', rest: '50"', grupo: '', obs: 'Fazer 8 repetições + 10" de isometria +8; fazer peg. pronada.', img: 'https://deepacupuntura.com/exe/remadaAparelhoNeutra.png' },
    { id: 2, num: 'Exercício 2', nome: 'Puxada hammer', sets: 3, reps: '10', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/puxadaNeutraFechada.jpg' },
    { id: 3, num: 'Exercício 3', nome: 'Remada na polia baixa', sets: 3, reps: '12 c/2"', rest: '50"', grupo: '', obs: 'Pegada neutra, segurando 2 segundos a cada repetição.', img: 'https://deepacupuntura.com/exe/remadaPoliaBaixa.gif' },
    { id: 4, num: 'Exercício 4', nome: 'Puxada pronada aberta', sets: 3, reps: '20', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/puxadaFrente.gif' },
    { id: 5, num: 'Exercício 5', nome: 'Crucifixo inverso aparelho', sets: 3, reps: '10', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/crucifixoDorsal.gif' },
    { id: 6, num: 'Exercício 6', nome: 'Remada alta na polia baixa', sets: 3, reps: '10 c/1"', rest: '50"', grupo: '', obs: 'Segurar 1 segundo a cada repetição.', img: 'https://deepacupuntura.com/exe/remadaAlta.gif' },
    { id: 7, num: 'Exercício 7', nome: 'Bíceps invertido + bíceps normal', sets: 3, reps: '10 +10', rest: '50"', grupo: '', obs: 'Fazer na polia baixa.', img: 'https://deepacupuntura.com/exe/bicepsPolia.gif' },
    { id: 8, num: 'Exercício 8', nome: 'Bíceps aparelho', sets: 3, reps: '12', rest: '50"', grupo: '', obs: 'Fazer 2 tempos.', img: 'https://deepacupuntura.com/exe/bicepsAparelho.gif' },
    { id: 9, num: 'Exercício 9', nome: 'Bíceps barra reta', sets: 3, reps: '8', rest: '50"', grupo: '', obs: 'Colocar a mão na barra na direção do ombro.', img: 'https://deepacupuntura.com/exe/bicepsBarra.gif' },
    { id: 10, num: 'Exercício 10', nome: 'Abdominal infra na paralela', sets: 3, reps: '20', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/abdominalInfraParalela.png' },
