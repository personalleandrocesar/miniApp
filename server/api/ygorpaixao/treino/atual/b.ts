export default defineEventHandler((event) => {
  return [
    ...
    { id: 4, num: 'Exercício 4', nome: 'Puxada Hammer', sets: 3, reps: '8', rest: '50"', grupo: '', obs: 'Pegada supinada.', img: 'https://deepacupuntura.com/exe/puxadaNeutraFechada.jpg' },
    { id: 5, num: 'Exercício 5', nome: 'Remada alta na polia baixa', sets: 3, reps: '12', rest: '50"', grupo: '', obs: 'Pegada fechada.', img: 'https://deepacupuntura.com/exe/remadaAlta.gif' },
    { id: 6, num: 'Exercício 6', nome: 'Bíceps corda na polia baixa', sets: 3, reps: '10', rest: '50"', grupo: '', obs: 'Pegada neutra.', img: 'https://deepacupuntura.com/exe/bicepsPolia.gif' },
    { id: 7, num: 'Exercício 7', nome: 'Bíceps barra reta', sets: 3, reps: '8', rest: '50"', grupo: '', obs: 'Pegada supinada.', img: 'https://deepacupuntura.com/exe/bicepsBarra.gif' },
    { id: 8, num: 'Exercício 8', nome: 'Flexora vertical', sets: 3, reps: '10', rest: '10"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/flexoraVertical.png' },
    { id: 9, num: 'Exercício 9', nome: 'Abdutora', sets: 3, reps: '15 (2t)', rest: '50"', grupo: '', obs: 'Fazer com 2 tempos na parte aberta.', img: 'https://deepacupuntura.com/exe/abdutora.gif' },
    { id: 10, num: 'Exercício 10', nome: 'Cadeira Flexora', sets: 3, reps: '20', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/flexora.gif' },
    { id: 11, num: 'Exercício 11', nome: 'Leg press horizontal', sets: 3, reps: '15', rest: '50"', grupo: '', obs: '', img: 'https://deepacupuntura.com/exe/legpress.gif' },
